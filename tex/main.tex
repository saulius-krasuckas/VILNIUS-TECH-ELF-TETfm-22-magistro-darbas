...
% PAPILDOMI PAKETAI IR NUSTATYMAI ----------------------------------------------
 ...
 \renewcommand{\numberline}[1]{#1.~~}  % uždeda tašką po skyriaus numeriu turinyje

 \patchcmd{\tableofcontents}           % nustatome turinio rašymą:
    {\contentsname}                    %
    {                                  %
        \centering                     % - su centravimu
        \MakeUppercase                 % - tik didžiosiomis raidėmis
        \contentsname                  %
    }                                  % Via: https://tex.stackexchange.com/a/293922
    {}{}                               % Via: https://tex.stackexchange.com/a/308207
...
\section{TYRIMŲ REZULTATŲ PALYGINIMAS}
